 ...
 * 依照公式，取x=1，y=z=0，r= 25,b=8/3 ,<img src="http://latex.codecogs.com/gif.latex?\sigma">=10 作图：[code](./temp.py)
  
 ...
  
  * Different regimes:[code](./untitled3.py)
